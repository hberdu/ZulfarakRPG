...
{
    // Magic projectile hurled by the NecromancerBoss at the player. Flies toward the
    // player's collider center, deals damage on hit, and bursts. Animated by the
    // necromancer's Magic(projectile) effect frames (Resources import); if none are
    // supplied it falls back to a procedural chunky purple orb so it always reads.
    public class MagicBolt : MonoBehaviour
    {
        ...
        private PlayerController2D _target;
        ...
        public void Init(PlayerController2D target, float damage, Sprite[] frames)
        {
            _target     = target;
            this.damage = damage;
